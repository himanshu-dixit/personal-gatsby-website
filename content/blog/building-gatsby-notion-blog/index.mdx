...
tags: ["frontend",]
---
import {ThemeToggle} from "../../../src/components/navbar/themetoggle.tsx"
...
Sadly, a lot of content format is not yet supported.
...
A major portion of my learning comes from project/startups I have worked on. So I wanted a page that could showcase my past project.

I wanted to give each project a unique look :D.

Also created a page of kind of work I do and how I can add add better value.
